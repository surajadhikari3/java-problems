...
public class Consumer implements Runnable {
    ...
    protected final static Map<String, Double> batchTotalPrice = new ConcurrentHashMap<>();
    protected final static Map<String, Double> batchAveragePrice = new ConcurrentHashMap<>();
        ...
        while (System.currentTimeMillis() - start < 10_000) {
            try {
                ...
                if (System.currentTimeMillis() - trade.getTimeStamp() > 5_000) {
                    ...
                    batchTotalPrice.merge(trade.getSymbol(), trade.getPrice(), Double::sum);
                    batchAveragePrice.put(trade.getSymbol(), batchTotalPrice.get(trade.getSymbol()) / batchTotalCount.get(trade.getSymbol()));
